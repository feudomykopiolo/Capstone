    ...
    <?php foreach ($sensors as $row): ?>
		<div class="col-lg-4 col-md-12">
			<div class="card">
				...
				<img class="" src="admin/theme-assets/images/sensors/wemos.jpg" alt="Card image cap">
				<div class="card-body">
					<p class="card-text"><?php echo $row['wemos']; ?></p>
				</div>
		...
		<div class="col-lg-4 col-md-12">
			<div class="card">
				...
				<img class="" src="admin/theme-assets/images/sensors/orange pi.jpg" alt="Card image cap">
				<div class="card-body">
				<p class="card-text"><?php echo $row['orange']; ?></p>
				</div>
				<div class="card-footer border-top-blue-grey border-top-lighten-5 text-muted">
				</div>
			</div>
		...
		<div class="col-lg-4 col-md-12">
			<div class="card">
				...
				<img class="" src="admin/theme-assets/images/sensors/uv sensor.jpg" alt="Card image cap">
				<div class="card-body">
				<p class="card-text"><?php echo $row['uv']; ?></p>
				</div>
				<div class="card-footer border-top-blue-grey border-top-lighten-5 text-muted">
					<span class="float-right">
						<a href="#" class="card-link">Read More
		...
		<div class="col-lg-4 col-md-12">
			<div class="card">
				...
				<img class="" src="admin/theme-assets/images/sensors/soil moisture.jpg" alt="Card image cap">
				<div class="card-body">
				<p class="card-text"><?php echo $row['soil']; ?></p>
				</div>
				<div class="card-footer border-top-blue-grey border-top-lighten-5 text-muted">
					<span class="float-right">
						<a href="#" class="card-link">Read More
		...
		<div class="col-lg-4 col-md-12">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Sensor</h4>
					<h6 class="card-subtitle text-muted">Temperature and Humidiyy</h6>
				</div>
				<img class="" src="admin/theme-assets/images/sensors/temp.jpg" alt="Card image cap">
				<div class="card-body">
				<p class="card-text"><?php echo $row['temp']; ?></p>
				</div>
				<div class="card-footer border-top-blue-grey border-top-lighten-5 text-muted">
					<span class="float-right">
						<a href="#" class="card-link">Read More
		...
		<div class="col-lg-4 col-md-12">
			<div class="card">
				...
				<img class="" src="admin/theme-assets/images/sensors/lcd.jpg" alt="Card image cap">
				<div class="card-body">
				<p class="card-text"><?php echo $row['lcd']; ?></p>
				</div>
				<div class="card-footer border-top-blue-grey border-top-lighten-5 text-muted">
					<span class="float-right">
						<a href="#" class="card-link">Read More
