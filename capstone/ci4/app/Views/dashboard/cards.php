    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="admin/theme-assets/images/backgrounds/02.jpg">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" active"><a href="cards"><i class="ft-layers"></i><span class="menu-title" data-i18n="">Drought Monitoring</span></a>
          </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="heading-elements" style="float: right;">
                        <button class="btn btn-primary view-button" onclick="window.location.href='GHPlot1';">View</button>
                    </div>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="heading-elements" style="float: right;">
                        <button class="btn btn-primary view-button" onclick="window.location.href='GHPlot2';">View</button>
                    </div>
                    <div style="clear: both;"></div> <!-- Clear float -->
                </div>
                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="heading-elements" style="float: right;">
                        <button class="btn btn-primary view-button" onclick="window.location.href='GHPlot3';">View</button>
                    </div>
                    <div style="clear: both;"></div> <!-- Clear float -->
                </div>
                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="heading-elements" style="float: right;">
                        <button class="btn btn-primary view-button" onclick="window.location.href='GHPlot4';">View</button>
                    </div>
                    <div style="clear: both;"></div> <!-- Clear float -->
                </div>
                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="heading-elements" style="float: right;">
                        <button class="btn btn-primary view-button" onclick="window.location.href='GHPlot5';">View</button>
                    </div>
                    <div style="clear: both;"></div> <!-- Clear float -->
                </div>
                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="heading-elements" style="float: right;">
                        <button class="btn btn-primary view-button" onclick="window.location.href='GHPlot6';">View</button>
                    </div>
                    <div style="clear: both;"></div> <!-- Clear float -->
                </div>
                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="heading-elements" style="float: right;">
                        <button class="btn btn-primary view-button" onclick="window.location.href='GHPlot7';">View</button>
                    </div>
                    <div style="clear: both;"></div> <!-- Clear float -->
                </div>
                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="heading-elements" style="float: right;">
                        <button class="btn btn-primary view-button" onclick="window.location.href='GHPlot8';">View</button>
                    </div>
                    <div style="clear: both;"></div> <!-- Clear float -->
                </div>
                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
